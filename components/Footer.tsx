        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
              <li><a href="#" className="hover:text-neon-green transition-colors">Work</a></li>
              <li><a href="#" className="hover:text-neon-green transition-colors">Services</a></li>
              <li><a href="#" className="hover:text-neon-green transition-colors">About</a></li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="text-zinc-400 hover:text-neon-blue transition-colors"><Twitter size={20} /></a>
              <a href="#" className="text-zinc-400 hover:text-neon-blue transition-colors"><Github size={20} /></a>
              <a href="#" className="text-zinc-400 hover:text-neon-blue transition-colors"><Linkedin size={20} /></a>
            </div>
